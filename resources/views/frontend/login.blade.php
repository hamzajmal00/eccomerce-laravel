...
<div class="col-md-6 col-sm-6 sign-in">
	...
	<form class="register-form outer-top-xs" action="{{ route('login') }}" method="POST">
		...
		<div class="radio outer-xs">
              ...
              <a href="{{ route('password.request') }}" class="forgot-password pull-right"><i class="ion ion-locked"></i> Forgot pwd?</a>
              @endif
		</div>
...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<form class="register-form outer-top-xs" action="{{ route('register') }}" method="POST" role="form">
        ...
        <div class="form-group">
		    ...
		    <input type="phone" id="phone" name="phone" class="form-control unicase-form-control text-input" id="exampleInputEmail1" >
		</div>
        <div class="form-group">
